...
[Chrome har fjernet alle resterende Manifest V2 (MV2)-udvidelser fra Chrome Webshop](https://adguard.com/en/blog/adguard-adblocker-manifestv2-removal.html), så Chrome-brugere behøver en MV3-udvidelse, der er kompatibel med Chromes nye API Manifest V3. Vores tanker om dette emne drøftes udførligt på [vores blog](https://adguard.com/en/blog/tag/manifest-v3.html).
