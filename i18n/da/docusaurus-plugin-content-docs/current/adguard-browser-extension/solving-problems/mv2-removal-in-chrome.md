...
af regler og ændrer, hvordan filtre opdateres. Før der skiftes, tjek artiklen [AdGuard Browser Extension til Chrome MV3](/adguard-browser-extension/mv3-version/).
...
For den fulde _Udviklertilstand_ → _Indlæs udpakket_ proces, se afsnittet _Sådan installeres udpakket i
webbrowseren_ i [Sådan fejlfindes i regler i AdGuard til Chrome MV3](/adguard-browser-extension/solving-problems/debug-rules/).
